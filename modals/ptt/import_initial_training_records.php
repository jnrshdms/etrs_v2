<div class="modal fade" id="import_initial_training_records" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../process/import/import_initial_training_records.php"  enctype="multipart/form-data" method="POST">
