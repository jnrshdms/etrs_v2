      ...
      <div class="modal-body">
           <div class="row">
                <div class="col-2">
                     ...
                     <span>Batch No:   </span> <input type="text" id="final_practice_batch_no_reupdate" class="form-control" class="noSpace" disabled>
                </div>
                <div class="col-2">
                     <span> SP ID Number:   </span> <input type="text" id="sp_id_reupdate_final_practice" class="form-control" autocomplete="OFF" class="noSpace" disabled>
                </div>
                <div class="col-2">
                     <span> FALP ID Number:   </span> <input type="text" id="emp_id_reupdate_final_practice" class="form-control" autocomplete="OFF" class="noSpace" disabled>
                </div>
                 <div class="col-3">
                     <span> Gender:   </span> <input type="text" id="final_practice_gender_reupdate" class="form-control"  autocomplete="OFF" class="noSpace" disabled>
                </div>  
                  <div class="col-3">
                     <span>Full Name:</span> <input type="text" name="final_full_name_update" id="final_practice_full_name_reupdate" class="form-control" disabled>
                 </div>              
           </div>
           <div class="row">
               
                 <div class="col-3">
                     <span>Department:</span> <input type="text" name="final_department_update" id="final_practice_department_reupdate" class="form-control" disabled>
                 </div>
                 <div class="col-3">
                     <span>Position:</span> <input type="text" name="final_position_update" id="final_practice_position_reupdate" class="form-control" disabled>
                 </div>
                 <div class="col-3">
                     <span>Date Hired:</span> <input type="text" name="final_date_hired_update" id="final_practice_date_hired_reupdate" class="form-control" disabled>
                 </div>
                 <div class="col-3">
           ...
           <div class="row">
                <div class="col-9">
                    <div class="float-left">
                        <button class="btn btn-danger" id="planbtnDelete" onclick="delete_final_practice_record()">Delete</button>
                    </div>
                </div>
                <div class="col-3">
                    <div class="float-right">
                        <button class="btn btn-primary" id="planbtnUpdate" onclick="reupdate_final_practice_record()">Update</button>
                    </div>
                </div>
            </div>
      </div>
