    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column">
          ...
          <li class="nav-item">
            <a href="viewer_records.php" class="nav-link">
...
theory_taken(unique_id);

training_taken_initial(unique_id);
// training_needs_initial();
training_taken_final(unique_id);
// training_needs_final();
training_taken_sb_initial(unique_id);
// training_needs_sb_initial();
training_taken_sb_final(unique_id);
  ...
  var position = document.getElementById('position_viewer').value;
   $.ajax({
      url: 'process/viewer.php',
                ...
                cache: false,
                data:{
                    method: 'fetch_theory_training_taken',
                    id:id,
                    batch_no:batch_no,
                    provider:provider,
                    employee_num:employee_num,
                   ...
                   document.getElementById('theory_taken').innerHTML = response;
