          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <table>
                  <tr>
                  <th><label>Batch  No:</label><input type="text" name="batch_no"  id="batch_no_view" class="form-control"></th>
                    <th></th>
                     <th><label>SP ID Number:</label><input type="text" name="sp_id" id="sp_id"  class="form-control"></th>
                  <th><label>FALP ID Number:</label><input type="text" name="employee_num" id="employee_num_view"  class="form-control"></th>
                    <th></th>

                  <th><label>Full Name:</label><input type="text" name="full_name" id="full_name_view"  class="form-control"></th>
                  </tr>
                </table>
                  </div>
                </h3>
              ...
              <!-- <div class="row">
                <div class="col-sm-6">
                  <a class="btn btn-success" href="../../process/export/export_training_record.php">Export</a>
                </div>
              </div> -->
              <!-- /.card-header -->
